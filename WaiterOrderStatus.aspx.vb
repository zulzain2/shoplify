...
Imports System.Net
Partial Class WaiterOrderStatus
    ...
    Protected Sub Timer1_Tick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        GridView1.DataBind()
        Label1.Text = "<h4 class='font-weight-bold'>Panel update at: " + DateTime.Now.ToLongTimeString() + " (Panel will be update every 10 seconds) <br /><br /></h4>"
