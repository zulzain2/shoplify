<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="WaiterOrderStatus.aspx.vb" Inherits="WaiterOrderStatus" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                       <ContentTemplate>
                                        ...
                                        <div style="overflow-x:auto;">
                                            ...
                                            <asp:Label runat="server" Text="Panel not update yet." id="Label1"></asp:Label>
