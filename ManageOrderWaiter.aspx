<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ManageOrderWaiter.aspx.vb" Inherits="ManageOrderWaiter" %>
     ...
     <!-- ============================================================== -->
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                     <h3 class="page-header"><i class="mdi mdi-account-multiple-plus"></i>&nbsp Waiter Manage Order</h3>
                </div>
                                        ...
                                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="ORDERID, ORDERFINALNUM">
                                            ...
                                            <ItemTemplate>
                                                <span style="">
                                                    ...
                                                    <div class="row">
                                                    <div class="col-md-6">
                                                    <h5 class="label label-inverse" style="line-height: 20px;"> <asp:Label Text='<%# Eval("ORDERMENUCODE") %>' runat="server" ID="ORDERMENUCODELabel" class="font-weight-bold font-20"/>&nbsp
                                                    <asp:Label Text='<%# Eval("MENUNAME") %>' runat="server" ID="MENUNAMELabel" class="font-20 font-weight-bold"/>&nbsp</h5>
                                                    <asp:Label Text='<%# Eval("MENUTYPE") %>' runat="server" ID="MENUTYPELabel"  class="font-20 font-weight-bold"/>&nbsp
                                                    <asp:Label Text='<%# Eval("MENUSETTYPE") %>' runat="server" ID="MENUSETTYPELabel" class="font-20 font-weight-bold"/><br />
                                                    ...
                                                    <asp:Label Text='<%# Eval("ORDERDESCRIPTION") %>' runat="server" ID="ORDERDESCRIPTIONLabel" /><br />
                                                        ...
                                                        <div class="col-md-3">
                                                           <div class="form-group">
                                                               <asp:Button ID="btnfinishorder" runat="server" CommandName="FINISHORDER" CommandArgument='<%# Container.DataItemIndex %>' Text="Deliver" class="font-weight-bold btn btn-success btn-lg btn-block" style="font-size: medium;"/> 
