<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TakeOrderWaiter.aspx.vb" Inherits="TakeOrderWaiter" %>
                           ...
                           <div class="row">
                             ...
                             <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:SqlDataSource runat="server" ID="SqlDataSource7" ConnectionString='<%$ ConnectionStrings:ShoplifyConnectionString %>' SelectCommand="SELECT [TABLENUM] FROM [SHOPLIFYRESTAURANTTABLE]"></asp:SqlDataSource>
