...
Imports System.Net
Partial Class MenuListCategory
    ...
    Private Sub ListView1_ItemCommand(sender As Object, e As ListViewCommandEventArgs) Handles ListView1.ItemCommand
        Response.Redirect("~/MenuListDetails.aspx?menucategory=" + e.CommandArgument)
    End Sub

    Private Sub btnviewallmenu_Click(sender As Object, e As EventArgs) Handles btnviewallmenu.Click
