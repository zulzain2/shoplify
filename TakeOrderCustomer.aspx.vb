...
Imports System.Net
Partial Class TakeOrderCustomer
    ...
    Private Sub InitializeMainFunction()
        Try
            ...
            If lrd.HasRows = True Then
                ...
                If OrderStatus = "DRAFT" And OrderTable = Request.QueryString("tablenum") Then
            ...
            Else
                Try
                    ...
                    Using cn As New SqlConnection(ConString)
                        ...
                        cmd.Parameters.AddWithValue("@ORDERTABLE", Request.QueryString("tablenum"))
    ...
    Private Sub btnOKsubmitorderdone_Click(sender As Object, e As EventArgs) Handles btnOKsubmitorderdone.Click
        ...
        Session("tablenum") = DropDownList1.Text.Trim

        Response.Redirect("~/OrderStatusCustomer.aspx?tablenum=" + DropDownList1.Text.Trim + "&currenttablestatus=OCCUPIED")
