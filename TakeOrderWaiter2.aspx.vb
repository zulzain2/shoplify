...
Imports System.Net
Partial Class TakeOrderWaiter2
    ...
    Private Sub ListView1_ItemCommand(sender As Object, e As ListViewCommandEventArgs) Handles ListView1.ItemCommand
        ...
        If e.CommandName = "ADDTOCART" Then
            ...
            Session("tmpMENUCODE") = ListView1.DataKeys(itemIndex).Values(1).ToString()
    ...
    Private Sub ListView4_ItemCommand(sender As Object, e As ListViewCommandEventArgs) Handles ListView4.ItemCommand

        If e.CommandName = "ADDTOCART" Then

            Dim itemIndex As Integer = Convert.ToInt32(e.CommandArgument)

            Session("tmpMENUCODE") = ListView4.DataKeys(itemIndex).Values(1).ToString()
    ...
    Private Sub ListView5_ItemCommand(sender As Object, e As ListViewCommandEventArgs) Handles ListView5.ItemCommand

        If e.CommandName = "ADDTOCART" Then

            Dim itemIndex As Integer = Convert.ToInt32(e.CommandArgument)

            Session("tmpMENUCODE") = ListView5.DataKeys(itemIndex).Values(1).ToString()
    ...
    Private Sub InitializeMainFunction()
        Try
            ...
            cn.Open()
            cmd.Connection = cn
            cmd.CommandText = "SELECT SHOPLIFYORDERTOTAL.ORDERNUM, SHOPLIFYORDER.ORDERSTATUS FROM SHOPLIFYORDERTOTAL INNER JOIN SHOPLIFYORDER ON SHOPLIFYORDERTOTAL.ORDERNUM = SHOPLIFYORDER.ORDERNUM"
    ...
    Private Sub InsertNewOrderTotal()
        ...
        Try
            ...
            xSQL.AppendLine("(ORDERNUM,ORDERFINALNUM, FINALORDERSTATUS)")
    ...
    Private Sub UpdateOrderTotal()
        ...
        Try
            ...
            xSQL.AppendLine("(ORDERMENUCODE ,ORDERNUM, ORDERQUANTITY , ORDERTAKEBY, ORDERTAKETIME, ORDERSTATUS, ORDERTOTALPRICE)")
            xSQL.AppendLine("VALUES")
            xSQL.AppendLine("(@ORDERMENUCODE, @ORDERNUM, @ORDERQUANTITY , @ORDERTAKEBY, @ORDERTAKETIME, @ORDERSTATUS, @ORDERTOTALPRICE)")
    ...
    Private Sub CalculateTotalOrder()
        ...
        Try
            ...
            If lrd2.HasRows = True Then
                ...
                Dim totalOrderQuantity As Int32 = 0
    ...
    Private Sub btnOKsubmitorder_Click(sender As Object, e As EventArgs) Handles btnOKsubmitorder.Click
        ...
        Try
            ...
            Using cn As New SqlConnection(ConString)
                ...
                cmd.Parameters.AddWithValue("@ORDERTABLE", DropDownList1.Text.Trim)
        ...
        Try
            ...
            Using cn As New SqlConnection(ConString)
                ...
                cmd.Parameters.AddWithValue("@TABLENUM", DropDownList1.Text.Trim)
    ...
    Private Sub hideorder_ServerClick(sender As Object, e As EventArgs) Handles hideorder.ServerClick
        rspshow.Style.Value = "display:none"
    End Sub

    Private Sub showorder_ServerClick(sender As Object, e As EventArgs) Handles showorder.ServerClick
        rspshow.Style.Value = "display:inline"
    End Sub
