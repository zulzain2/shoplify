<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="MenuActivation.aspx.vb" Inherits="MenuActivation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                     <h3 class="page-header"><i class="mdi mdi-book-multiple"></i>&nbsp Menu Activation</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item">Menu Master</li>
                        <li class="breadcrumb-item font-bold">Menu Activation</li>
                    </ol>
                </div>
            ...
            <div class="card" style="background-color:#f4f6f9">
              ...
              <div class="col-lg-3 col-6">
                 ...
                 <asp:LinkButton ID="btneditmenu" runat="server" class="btn btn-outline-info btn-block" ><i class="fas fa-edit"></i> Edit</asp:LinkButton>
                    ...
                    <div class="col-lg-3 col-6">
                 <asp:LinkButton ID="btnenabledisbalemenu" runat="server" class="btn btn-info btn-block" ><i class="mdi mdi-book-open"></i> Activation</asp:LinkButton>
             </div>
                        <%End If %>
                    </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div style="overflow-x:auto;">
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped gvv" HeaderStyle-HorizontalAlign="Center" AutoGenerateColumns="False" DataKeyNames="MENUCATEGORYNAME" DataSourceID="SqlDataSource1" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Available.">
                                <Columns>
                                    <asp:TemplateField HeaderText="ACTION" SortExpression="MENUCATEGORYNAME" ItemStyle-HorizontalAlign="Center">
                                        <EditItemTemplate>
                                            <asp:Label runat="server" Text='<%# Eval("MENUCATEGORYNAME") %>' ID="Label1"></asp:Label>
                                        </EditItemTemplate>
                                        <ItemTemplate>
